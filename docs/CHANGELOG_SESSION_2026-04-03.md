...
```
**Effekt:** Query "Preisblatt CHF" findet `Anhang2_Preisblatt_Beispiel.pdf` mit höherem Score.
...
#### CSV-Dokumente
```
[CSV | simap_Fragen_beispiel.csv | Frage 42]
{"Nr": "42", "Lieferant": "Vendor X", "Frage": "...", "Antwort": ""}
```

#### DOCX/PDF-Dokumente
```
[Pflichtenheft (Projekt) | Pflichtenheft_Webportal_Beispiel.docx]
Das Webportal muss eine REST-API bereitstellen für...
```

#### Preisblatt-Tabelle (nachher)
```
[Anforderung/Feature | Anhang2_Preisblatt_Beispiel.pdf]
Umsetzungskosten | 0 CHF
```
...
**Reihenfolge:**
1. CSV (simap_Fragen_beispiel.csv)
2. Preisblatt (Anhang2_Preisblatt_Beispiel.pdf)
...
[
    {
        "document_id": 6,
        "filename": "Anhang2_Preisblatt_Beispiel.pdf",
    ...
    {
        "filename": "Pflichtenheft_Webportal_Beispiel.docx",
        "best_score": 0.51,
        "included": True,
        "reason": ""
    }
...
```
✅ Eingeschlossen (>= 45%):
  51% | Pflichtenheft_Webportal_Beispiel.docx
  50% | Anhang2_Preisblatt_Beispiel.pdf

⚠️ Ausgeschlossen:
  39% | Anhang_Ausschreibung_Beispiel.docx | Score 39% < Threshold 45%
