...
│
├── 🚀 DEPLOYMENT (systemd + nginx, kein Docker)
│   └── deployment/
│       ├── README.md
│       ├── deploy-debian.sh
│       ├── nginx/
...
│   └── docs/
│       ├── ARCHITECTURE.md
│       ├── OFFERTBEURTEILUNG_OPS.md   # Phase C Betrieb, Export, CLI
│       ├── SERVER_SETUP.md
│       ├── deployment/
...
│
├── ⚙️ KONFIGURATION
│   ├── config/                    # App-Configs (YAML, gitignored Ziele)
...
|--------------|-------|-----------------|
| `requirements.txt` | Python-Dependencies | venv / pip |
...
- ✅ nginx-Vorlagen unter `deployment/nginx/`
