...
# Get certificate
sudo certbot certonly --nginx -d mainedomain.com -d *.mainedomain.com
...
```bash
# Test cert
sudo openssl x509 -in /etc/letsencrypt/live/mainedomain.com/fullchain.pem -text -noout
...
|---------|-----|-------------------|
| **ProjektHub** | `https://projekthub.mainedomain.com` | 2FA ✅ |
| **Authelia Dashboard** | `https://auth.mainedomain.com` | 2FA ✅ |
| **Backend API** | `https://projekthub.mainedomain.com/api/docs` | 2FA ✅ |
